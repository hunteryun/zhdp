...
class ArticleViewController extends Base
{
    ...
    public function index(Request $request)
    {
        ...
        $articleViewList = AdminModel::where('token', $this->admin_token())->firstOrFail()->article_view()->paginate($limit)->toArray();
        $returnData = [];
        $returnData['msg']              = "查询成功";
    ...
    public function update(Request $request, $id){
        ...
        $ArticleViewInfo = AdminModel::where('token', $this->admin_token())->firstOrFail()->article_view()->where('id', $id)->firstOrFail();
    ...
    public function destroy(Request $request, $id){
        ...
        $deletearticleViewStatus = AdminModel::where('token', $this->admin_token())->firstOrFail()->article_view()->where('id', $id)->firstOrFail()->delete();
    ...
    {
        $limit  = $request->input('limit');
        $deviceRegionList = AdminModel::where('token', $this->admin_token())->firstOrFail()->article_view()->whereHas('article', function($query){
            $request = request();
