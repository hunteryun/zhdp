...
class ArticleController extends Base
{
    ...
    public function update(Request $request, $id){
        ...
        $articleInfo = AdminModel::where('token', $this->admin_token())->firstOrFail()->article()->where('id', $id)->firstOrFail();
    ...
    public function destroy(Request $request, $id){
        ...
        $deleteDeviceRegionStatus = AdminModel::where('token', $this->admin_token())->firstOrFail()->article()->where('id', $id)->firstOrFail()->delete();
    ...
    public function my(Request $request)
    {
        ...
        $limit  = $request->input('limit');
        $deviceRegionList = AdminModel::where('token', $this->admin_token())->firstOrFail()->article()->where($where)->orderBy('id','desc')->with( 'article_class', 'crop_class')->paginate($limit)->toArray();
        $returnData = [];
        $returnData['msg']              = "查询成功";
        $returnData['count']            = $deviceRegionList['total'];
        $returnData['current_page']     = $deviceRegionList['current_page'];
