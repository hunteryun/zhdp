...
class DeviceEventController extends Base
{
    ...
    public function index(Request $request)
    {
        ...
        // 
        $deviceList = UserModel::where('token', $this->user_token())->firstOrFail()->device_event()->with("device", "device_field", "associated_device", "associated_device_field")->paginate($limit)->toArray();
        $returnData = [];
        $returnData['msg']              = "查询成功";
