 ...
 <body>
    <div class="layui-container" style="padding:15px">
     ...
     <script>
        //  获取父页面传过来的值
        var crop_class_info =  window.parent.edit_crop_class_info;
        //  初始化input
        $("input[name='name']").val(crop_class_info.name);
        //  获取作物分类列表
        ...
        $.ajax({ 
            ...
            success: function(result){
                ...
                if (result.code > 0) {
                    ...
                    var html='<option value="">请选择作物分类</option>';
                    $.each(result.data,function(key,value){
                        if(value.id == crop_class_info.pid){
         ...
         form.on('submit(formSubmit)', function(data) {
             ...
             $.ajax({ 
                type: "POST",
                url: '{{url("api/admin/crop_class")}}/' + crop_class_info.id,
                data: {
                    '_method': 'PUT',
                    'pid': data.field.pid,
