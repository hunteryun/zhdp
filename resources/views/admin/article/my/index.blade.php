 ...
 <body>
     ...
     <script>
            ...
            table.on('tool(article)', function(obj){
                ...
                if(obj.event === 'view'){
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/article/info")}}',
                        end:function(){
                            table.reload('article');
                        }
                    });
                }else if(obj.event === 'edit'){
                    window.edit_article_info = data;
                    layer.open({
                        type:2,
                        title:'文章编辑',
                        shadeClose:true,
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/article/my/edit")}}',
                        end:function(){
                            table.reload('article');
                        }
                    });
            ...
            $.ajax({ 
                type: "GET",
                url: '{{url("api/admin/crop_class/all_child")}}',
                success: function(result){
