     ...
     <div class="layui-card">
         <div class="layui-card-body">
            ...
            <div class="layui-row">
                ...
                <table lay-size="sm" id="field_type" lay-filter="field_type"></table>
            </div>
         </div>
     </div>
     ...
     <script>
            ...
            table.on('tool(field_type)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({ 
                            type: "POST",
                            url: '{{url("api/admin/field_type")}}/'+ data.id,
                            data: {
                                '_method': 'DELETE',
                                'name': data.value,
                            },
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/field_type/edit")}}',
                        end:function(){
                            table.reload('field_type');
                        }
                    });
            ...
            $('#add-device-region').click(function(){
                layer.open({
                    ...
                    shade:0.8,
                    area:['100%','100%'],
                    content:'{{url("admin/field_type/add")}}',
                    end:function(){
                        table.reload('field_type');
                    }
                });
