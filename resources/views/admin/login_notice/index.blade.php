 ...
 <body>
     ...
     <script>
            table.render({
                elem: '#login_notice'
                ,url: '{{url('api/admin/login_notice')}}' 
                ,page: true 
                ,cols: [[ 
            ...
            table.on('tool(login_notice)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({ 
                            type: "POST",
                            url: '{{url("api/admin/login_notice")}}/'+ data.id,
                            data: {
                                '_method': 'DELETE',
                                'name': data.value,
                            },
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/login_notice/info")}}',
                    });
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/login_notice/edit")}}',
                        end:function(){
                            table.reload('login_notice');
                        }
                    });
            ...
            $('#add-login_notice').click(function(){
                layer.open({
                    ...
                    shade:0.8,
                    area:['100%','100%'],
                    content:'{{url("admin/login_notice/add")}}',
                    end:function(){
                        table.reload('login_notice');
                    }
                });
