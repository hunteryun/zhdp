 ...
 <body>
     ...
     <script>
         var product_id = window.parent.product_id;
            table.render({
                elem: '#product_field'
                ,url: '{{url('api/admin/product/product_field/all')}}?product_id='+product_id
                ,page: false 
                ,cols: [[ 
            ...
            table.on('tool(product_field)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({ 
                            type: "POST",
                            url: '{{url("api/admin/product/product_field")}}/'+ data.id,
                            data: {
                                '_method': 'DELETE',
                                'name': data.value,
                            },
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("admin/product/product_field/edit")}}',
                        end:function(){
                            table.reload('product_field');
                        }
                    });
            ...
            $('#add-product-field-region').click(function(){
                ...
                layer.open({
                    ...
                    shade:0.8,
                    area:['100%','100%'],
                    content:'{{url("admin/product/product_field/add")}}',
                    end:function(){
                        table.reload('product_field');
                    }
                });
