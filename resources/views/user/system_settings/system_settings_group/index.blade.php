 ...
 <body>
     ...
     <script>
            table.render({
                ...
                ,url: '{{url('api/user/system_settings/system_settings_group')}}' 
                ,page: true 
                ,cols: [[ 
            ...
            table.on('tool(system_settings_group)', function(obj){
                ...
                if(obj.event === 'del'){
                    ...
                    layer.confirm('真的删除行么', function(index){
                        $.ajax({ 
                            type: "POST",
                            url: '{{url("api/user/system_settings/system_settings_group")}}/'+ data.id,
                            data: {
                                '_method': 'DELETE',
                                'name': data.value,
                            },
                    ...
                    layer.open({
                        ...
                        shade:0.8,
                        area:['100%','100%'],
                        content:'{{url("user/system_settings/system_settings_group/edit")}}',
                        end:function(){
                            table.reload('system_settings_group');
                        }
                    });
            ...
            $('#add-system_settings_group').click(function(){
                layer.open({
                    ...
                    shade:0.8,
                    area:['100%','100%'],
                    content:'{{url("user/system_settings/system_settings_group/add")}}',
                    end:function(){
                        table.reload('system_settings_group');
                    }
                });
