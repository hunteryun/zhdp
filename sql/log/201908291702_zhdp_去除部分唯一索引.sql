...
INSERT INTO `device_field` (`id`, `device_id`, `name`, `field`, `field_type_id`, `value`, `length`, `common_field`, `common_field_sort`, `desc`, `sort`, `created_at`, `updated_at`, `deleted_at`) VALUES
