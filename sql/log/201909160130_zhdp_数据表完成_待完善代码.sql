...
(13, 890, 10, '2019-09-14 02:20:20', '2019-09-11 17:23:06'),
...
(899, 'number', 10, '0', '数值类型', '2019-09-14 23:24:03', '2019-09-14 23:24:03', NULL);
...
(1, '智慧云平台欢迎您', '<p><br></p><p><br></p><p><br></p><p>如有任何疑问，请及时联系客服<img src=\"http://code9.com:8080/js/layui-v2.5.4/images/face/0.gif\" alt=\"[微笑]\"></p>', '0', '2019-09-15 13:11:05', '2019-09-15 13:06:59'),
...
(26, 4, 899, '1', '2019-09-15 13:37:41', NULL),
...
(43, 5, 890, '0', '2019-09-15 13:38:33', '2019-09-15 13:38:33'),
...
(52, 5, 899, '1', '2019-09-15 13:38:40', '2019-09-15 13:38:33');
...
INSERT INTO `system_settings_group` (`id`, `name`, `desc`, `created_at`, `updated_at`, `deleted_at`) VALUES
(900, '系统设置', NULL, '2019-09-16 00:22:51', '2019-09-16 00:25:37', NULL);
...
(900, 900, '测试', '测试', '测试', '0', NULL, '测试', '2019-09-16 00:58:42', '2019-09-16 00:58:42', NULL),
(902, 900, 'name', 'name', NULL, '3', NULL, 'name', '2019-09-16 01:01:02', '2019-09-16 01:01:02', NULL);
...
(890, '13800138000', '123456', '0jxOthQIschxfvZqQqKPXyTkuF5k2yvdOoR7DIKX0OAELCitIclDZC6K7ECi', '2019-09-01 08:46:59', '2019-09-15 23:44:15', NULL),
...
(899, '13808888', '13808888', '8WxzMLCkYGX1OBvnsrwJuVAJN3bBhZddWi2KLGIJakUk12tZPmNrsFOiHwQS', '2019-09-01 09:37:38', '2019-09-15 11:27:17', NULL);
...
--
ALTER TABLE `device_event`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '字段所属设备id', AUTO_INCREMENT=909;

--
-- 使用表AUTO_INCREMENT `device_event_log`
--
ALTER TABLE `device_event_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '字段所属设备id', AUTO_INCREMENT=908;
...
--
ALTER TABLE `login_notice`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '登录通知内容', AUTO_INCREMENT=6;

--
-- 使用表AUTO_INCREMENT `login_notice_log`
--
ALTER TABLE `login_notice_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '登录通知日志内容', AUTO_INCREMENT=53;
...
--
ALTER TABLE `pest_warning_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '登录通知日志内容', AUTO_INCREMENT=82;
...
--
ALTER TABLE `system_msg`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '登录通知日志内容', AUTO_INCREMENT=2;
