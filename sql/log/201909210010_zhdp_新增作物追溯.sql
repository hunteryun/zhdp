...
(900, '123456', '123456', '', NULL, '2019-09-20 23:33:14', NULL);
...
CREATE TABLE `crop_traceability_batch` (
  ...
  `sampling_status` enum('0','1') COLLATE utf8_bin NOT NULL DEFAULT '0' COMMENT '抽检状态',
...
(890, '13800138000', NULL, '123456', 'UW9YVCEA8aAAJHrlvfWPwENEHY3GeUnQTA5ohXSqfn2XdZY10anEBKfHEV3s', '2019-09-01 08:46:59', '2019-09-20 23:33:32', NULL),
...
--
ALTER TABLE `crop_traceability_batch`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '收获批次(系统填充)';
