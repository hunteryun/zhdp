...
CREATE TABLE `article_class` (
  ...
  `desc` varchar(255) COLLATE utf8_bin NOT NULL DEFAULT '0' COMMENT '分类描述',
  `updated_at` datetime DEFAULT NULL,
  `created_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(890, '13800138000', '123456', '3SsSuZsEpJx76MD3nsR8dzW4iBWhQxnnZaSOHBSRAUyuV9x6JwgqLT75NJBk', '2019-09-01 08:46:59', '2019-09-10 17:38:22', NULL),
